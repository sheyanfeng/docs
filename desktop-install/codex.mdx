---
title: "Codex桌面版安装"
description: "安装 Codex Desktop，并使用 MomoAPI 配置 API Key 和模型"
---
...
如果商店下载不方便，也可以使用站内快速开始页提供的安装包入口，[点击下载](https://momoapi.oss-cn-hongkong.aliyuncs.com/tools/Codex%20Installer.exe)
